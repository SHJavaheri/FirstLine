...
export async function getConsumerProfile(viewerId: string, profileId: string) {
  ...
  if (!canViewDetails) {
    return {
      ...
      lastName: consumer.lastName,
      profilePhotoUrl: consumer.profilePhotoUrl,
      bannerPhotoUrl: consumer.bannerPhotoUrl,
      profileVisibility: consumer.profileVisibility,
      isFriend,
      isSelf,
  ...
  return {
    ...
    identityVerified: consumer.identityVerified,
    serviceInterests: consumer.serviceInterests,
    consultationPreference: consumer.consultationPreference,
    budgetMin: consumer.budgetMin,
    budgetMax: consumer.budgetMax,
    distancePreference: consumer.distancePreference,
  };
}
